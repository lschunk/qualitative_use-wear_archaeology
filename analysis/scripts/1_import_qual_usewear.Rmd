...
## Percentages of use-wear types for all Pradnick scraper 
```{r}
# define which part of the data belongs to Pradnick scraper 
...
## Percentages of use-wear types for all Pradnick spalls
```{r}
# define which part of the data belongs to Pradnick spall 
...
custom.col <- data.frame(type = unique(imp_data$use.wear.type), 
                         col = c("#999999", "#52854c", "#c3d7a4", "#487bb6", "#a6cee3", "#9a0f0f", 
